...
At the top right corner, you'll find the **+ New Affiliate** button. Click this to manually add a new affiliate to your program without requiring them to sign up themselves. (We'll show you how to do that later in this guide.) If you want affiliates to register themselves, see [How to Register as an Affiliate](../affiliate-portal/how-to-register-as-an-affiliate.md).
