...
### Step 2. Installing FluentAffiliate Pro Addons (Requires Base Plugin)

If you have purchased FluentAffiliate Pro Addons for advanced features, you will need to upload and activate them. Ensure the Free Base Plugin (from step 1) is already installed and active before proceeding with Pro Addons.

1. Download the FluentAffiliate Pro Addons **.zip** file from your WPManageNinja dashboard.
2. Navigate to your WordPress dashboard.
3. Go to **Plugins** > **Add New**.
4. At the top of the page, click the "**Upload Plugin**" button.
5. Click "**Choose File**", then select the **FluentAffiliate Pro Addons .zip** file you downloaded.
6. Click "**Install Now**".
7. Once the installation is complete, click "**Activate Plugin**".


### Step 3. Activating Your FluentAffiliate Pro Addons License
...
5. In the "**License Key**" field, enter the unique license key you received upon purchasing **FluentAffiliate Pro Addons** from **WPManageNinja**.
