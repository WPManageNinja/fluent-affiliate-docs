...
SureCart is a WordPress e-commerce plugin that is designed for selling products and services online easily. If you want to grow your sales through affiliate marketing, the **FluentAffiliate** plugin allows you to manage affiliate commissions for product sales.
...
Once SureCart is active, go to the **FluentAffiliate Dashboard**. From there, click on the **Settings** tab in the top menu. On the left sidebar, you'll find an option called **Integration Settings**. Simply click on that.

Inside Integration Settings, you'll see a list of different integration options. Find **SureCart** in this list. Now, simply click on the **toggle** button to enable SureCart integration with FluentAffiliate.
...
In the **Affiliate Links** section, paste the **URL** of the SureCart product page you want to promote. Click on the **Generate** button. FluentAffiliate will generate a unique **affiliate link** for you.
...
- **Integration Toggle Not Visible:** Ensure both SureCart and FluentAffiliate are activated. If the issue persists, deactivate and reactivate both plugins, then check again.
