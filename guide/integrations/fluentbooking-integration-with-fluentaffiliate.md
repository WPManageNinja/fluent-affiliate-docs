...
3. **Add More Rates:** You can click the **+Add New Group** button again to create more custom commission rules for any specific booking events. To remove a rule, click the **delete** icon on the right.
