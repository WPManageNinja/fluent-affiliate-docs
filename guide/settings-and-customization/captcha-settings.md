...
description: Learn how to configure captcha settings in FluentAffiliate to protect your affiliate registration form from spam and bot sign-ups using Google reCAPTCHA.
---
...
![Captcha Settings](/images/settings-and-customization/registration-settings/captcha-settings/captcha-1.webp)
