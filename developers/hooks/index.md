...
### [Action Hooks](/developers/hooks/actions/)
...
### [Filter Hooks](/developers/hooks/filters/)
...
- **[Affiliate Module](/developers/hooks/actions/affiliate/)** - 7 hooks for affiliate lifecycle management
- **[Referral Module](/developers/hooks/actions/referrals/)** - 6 hooks for referral tracking
- **[Transaction Module](/developers/hooks/actions/transactions/)** - 6 hooks for payment processing
- **[Group Module](/developers/hooks/actions/groups/)** - 3 hooks for group management
- **[Integration Module](/developers/hooks/actions/integrations/)** - 1 hook for third-party plugins
- **[Auth Module](/developers/hooks/actions/auth/)** - 2 hooks for authentication
- **[Portal Module](/developers/hooks/actions/portal/)** - 1 hook for email templates
- **[Admin Module](/developers/hooks/actions/admin/)** - 2 hooks for admin interface

### Filter Hooks (25+ hooks across 4 modules)
- **[Configuration & Settings](/developers/hooks/filters/configuration/)** - 11 hooks for system configuration
- **[Portal & UI](/developers/hooks/filters/portal/)** - 7 hooks for interface customization
- **[Authentication](/developers/hooks/filters/authentication/)** - 6 hooks for auth workflows
- **[Tracking & Analytics](/developers/hooks/filters/tracking/)** - 2 hooks for tracking configuration
